...
보호자의 **자녀 위치** 탭에서 날짜를 고르고 **시간별 기록**을 살펴봅니다. 위치 기록을 누르면 해당 시각의 OpenStreetMap 지도로 이동합니다. 별도 지도 API 키 없이 지도 이동·확대·축소와 **표시 위치로** 이동을 사용할 수 있습니다. **최신 기록** 버튼으로 돌아올 수 있습니다. 측정 시간·좌표·위치 오차와 과거 위치 안내를 함께 표시합니다. 지도 위의 자동 공유 상태 카드와 앱 상단의 일반 동작 안내 배너는 표시하지 않습니다. 입력 오류·전송 실패 안내는 확인할 수 있습니다.
