...
0.6.3은 대화 화면을 보고 있을 때 빠르게 수신하고, 화면을 닫으면 새 메시지 유무에 따라 5→10→20→30→60초로 확인 간격을 조절합니다. 새 메시지를 저장하면 다시 5초부터 확인합니다. 이동 중 위치 요청은 약 20초, 정지 시에는 유예 후 약 5분 간격입니다. Firebase나 별도 가족 서버를 사용하지 않습니다. [변경 사항과 확인 범위](docs/releases/0.6.3.md)
